		...
		<div id="content">
			<div id="contentInner">
				<div class="mainContent">
					<h1>Canciones <span class="filterName"><? if($_GET["filtro"]=="origen"){ echo "de ".$_GET["valor"]; } else if($_GET["filtro"]=="idioma"){ echo "en ".$_GET["valor"]; }?></span></h1>
					<div id="results">
						<div class="songRow">
						<?
							$cont = 0;
							...
							else
							{
								print("<div class=\"song last\">");
									...
									print("<div class=\"songInner\">");
										print("<a href=\"player.php?idVideo=".$row['id']."&tipo=".$row['extension']."\"><img src=\"_thumbs/".$row['id'].".jpg\" height=\"118\" width=\"149\"/></a>");
						...
						<ul>
							...
							if($totalpaginas > 1){
								echo "<li><a href=\"canciones.php?filtro=".$_GET["filtro"]."&valor=".$_GET["valor"]."&pagina=1\">&laquo; Primera </a></li>";
								
								if($pagina > 1)
									echo "<li><a href=\"canciones.php?filtro=".$_GET["filtro"]."&valor=".$_GET["valor"]."&pagina=".($pagina -1)."\">&lsaquo; Anterior </a></li>";
								...
								if($pagina < $totalpaginas)
									echo "<li><a href=\"canciones.php?filtro=".$_GET["filtro"]."&valor=".$_GET["valor"]."&pagina=".($pagina +1)."\"> Siguiente &rsaquo;</a></li>";
								
								echo "<li><a href=\"canciones.php?filtro=".$_GET["filtro"]."&valor=".$_GET["valor"]."&pagina=".$totalpaginas."\"> &Uacute;ltima &raquo;</a></li>";
							}	
					...
					<div class="filters">
						...
						<ul>
							...
							?>
							<li class="lastInList"><a href="origenes.php">Ver todos los or&iacute;genes</a></li>
						</ul>
						<h2>Por idioma</h2>
						<ul>
							...
							?>
							<li class="lastInList"><a href="idiomas.php">Ver todos los idiomas</a></li>
						</ul>
					</div>
					<div class="clearBoth"></div>
				</div><!-- End #MainContent -->
